...
class HelpersTestCase(unittest.TestCase):
    ...
    def testGetRuleByName(self):
        ...
        self.assertTrue(
            isinstance(
                typo._get_rule_by_name('testrule'), collections.Callable))
        self.assertEqual(
            'rl_testrule',
    ...
    def testResolveRule(self):
        ...
        self.assertTrue(
            isinstance(
                typo._resolve_rule_name('testrule')[1], collections.Callable))
        self.assertTrue(
            isinstance(
                typo._resolve_rule_name(cb_testrule)[1], collections.Callable))
        self.assertEqual(
            'testrule',
    ...
    def testResolveRuleWithForcedName(self):
        ...
        """
        self.assertTrue(
            isinstance(typo._resolve_rule_name('testrule', 'newrule')[1], collections.Callable))
        self.assertTrue(
            isinstance(typo._resolve_rule_name(cb_testrule, 'newrule')[1], collections.Callable))
        self.assertEqual(
            'newrule',
