...
class InWordsTestCase(unittest.TestCase):
    ...
    def testWithGender(self):
        ...
        """
        self.assertEqual(
            pytils.numeral.in_words(21, pytils.numeral.MALE), "двадцать один"
        )
        self.assertEqual(
            pytils.numeral.in_words(21, pytils.numeral.FEMALE), "двадцать одна"
        )
        self.assertEqual(
            pytils.numeral.in_words(21, pytils.numeral.NEUTER), "двадцать одно"
        )
        # на дробные пол не должен влиять - всегда в женском роде
        self.assertEqual(
...
class SumStringTestCase(unittest.TestCase):
    ...
    def ckMaleOldStyle(self, amount, estimated):
        ...
        """
        self.assertEqual(
            pytils.numeral.sum_string(amount, 1, self.variants_male), estimated
        )
    ...
    def ckFemaleOldStyle(self, amount, estimated):
        ...
        """
        self.assertEqual(
            pytils.numeral.sum_string(amount, 2, self.variants_female), estimated
        )
    ...
    def ckFemale(self, amount, estimated):
        ...
        self.assertEqual(
            pytils.numeral.sum_string(
                amount, pytils.numeral.FEMALE, self.variants_female
            ),
            estimated,
        )
    ...
    def testSumString(self):
        ...
        self.assertEqual(
            "одиннадцать негритят",
            pytils.numeral.sum_string(
                11, pytils.numeral.MALE, "негритенок,негритенка,негритят"
            ),
        )
