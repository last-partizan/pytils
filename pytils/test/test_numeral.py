...
class RublesTestCase(unittest.TestCase):
    ...
    def testRubles(self):
        ...
        self.assertEquals(pytils.numeral.rubles(10.01, False, True),
                          u"десять белорусских рублей одна копейка")
        self.assertEquals(pytils.numeral.rubles(10.10, False, True),
                          u"десять белорусских рублей десять копеек")
        self.assertEquals(pytils.numeral.rubles(2.353, False, True),
                          u"два белорусских рубля тридцать пять копеек")
        self.assertEquals(pytils.numeral.rubles(2.998, False, True),
                          u"три белорусских рубля")
        self.assertEquals(pytils.numeral.rubles(3, False, True),
                          u"три белорусских рубля")
        self.assertEquals(pytils.numeral.rubles(3, True, True),
                          u"три белорусских рубля ноль копеек")
        self.assertEquals(pytils.numeral.rubles(long(3), False, True),
                          u"три белорусских рубля")
