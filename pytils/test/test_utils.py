...
class ChecksTestCase(unittest.TestCase):
    ...
    def testCheckPositive(self):
        ...
        self.assertRaises(
            ValueError, pytils.utils.check_positive, decimal.Decimal("-2.0")
        )
...
class SplitValuesTestCase(unittest.TestCase):
    def testClassicSplit(self):
        ...
        """
        self.assertEqual(
            ("Раз", "Два", "Три"), pytils.utils.split_values("Раз,Два,Три")
        )
        self.assertEqual(
            ("Раз", "Два", "Три"), pytils.utils.split_values("Раз, Два,Три")
        )
        ...
        self.assertEqual(
            ("Раз", "Два", "Три"), pytils.utils.split_values(" Раз, \nДва,\n Три  ")
        )
    ...
    def testEscapedSplit(self):
        ...
        self.assertEqual(
            ...
            pytils.utils.split_values(r"Раз\,Два,Три\,Четыре,Пять\,Шесть"),
        )
        self.assertEqual(
            ("Раз, Два", "Три", "Четыре"),
            pytils.utils.split_values(r"Раз\, Два, Три, Четыре"),
        )
