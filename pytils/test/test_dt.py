...
class DistanceOfTimeInWordsTestCase(unittest.TestCase):
    ...
    def testDOTWDatetimeType(self):
        ...
        self.assertEqual(pytils.dt.distance_of_time_in_words(
    ...
    def testIssue25DaysFixed(self):
        ...
        self.assertEqual(pytils.dt.distance_of_time_in_words(d_days),
                          "13 дней назад")
    ...
    def testIssue25HoursFixed(self):
        ...
        self.assertEqual(pytils.dt.distance_of_time_in_words(d_hours),
                          "13 часов назад")
