...
def rl_wordglue(x):
    ...
    patterns = (
        ...
        (re.compile(u'(^|\\s|\u202f)([a-zA-ZА-Яа-я]{1,3})(\\s+)', re.UNICODE), u'\\1\\2\u202f'),
        # то же самое -- второй проход нужен когда два коротких слова подряд
        # например "он не почуял неладное"
        # если один раз, то "(1=^)(2=Он)( )не почуял неладное", пробел после "не" не обрабатывается
        (re.compile(u'(\u202f)([a-zA-ZА-Яа-я]{1,3})(\\s+)', re.UNICODE), u'\\1\\2\u202f'),
